...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.groupBox_2.setGeometry(QRect(1140, 230, 301, 371))
        ...
        self.btnMakeShort.setGeometry(QRect(40, 300, 91, 41))
        self.btnMakeLong = QPushButton(self.groupBox_2)
        self.btnMakeLong.setObjectName(u"btnMakeLong")
        self.btnMakeLong.setGeometry(QRect(180, 300, 91, 41))
        ...
        self.groupBox_3.setGeometry(QRect(1140, 40, 301, 121))
